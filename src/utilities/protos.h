...
HYPRE_Int hypreDevice_GetInvDiag(HYPRE_Int n, HYPRE_Int *A_i, HYPRE_Complex *A_data, HYPRE_Complex *inv_diag);
...
HYPRE_Int hypreDevice_FusedDiagScaleVectorAxpy(HYPRE_Int n, HYPRE_Complex *A_inv_diag, HYPRE_Complex *x, HYPRE_Complex *y, HYPRE_Complex *z);
HYPRE_Int hypreDevice_DiagScaleVector2(HYPRE_Int n, HYPRE_Complex *A_inv_diag, HYPRE_Complex *x, HYPRE_Complex beta, HYPRE_Complex *y, HYPRE_Complex *z, HYPRE_Int computeY);
