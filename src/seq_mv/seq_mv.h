...
typedef struct
{
   ...
   HYPRE_Int rebuildTriMats; // Every time HYPRE_IJMatrixInitialize is called, this flag is set to 1. After D, L and U are built, the flag is set to 0
   HYPRE_Int rebuildTriSolves; // Every time HYPRE_IJMatrixInitialize is called, this flag is set to 1. After Solve Data for L and/or U are built, the flag is set to 0
#endif
